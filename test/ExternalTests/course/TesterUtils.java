public class TesterUtils {
    ...
    public static void printStatus(SuccessStatus[] success, int actualOperations, int wavlOperations) {
        printStatus(success,actualOperations,wavlOperations,true);
    }

    public static void printStatus(SuccessStatus[] success, int actualOperations, int wavlOperations, boolean verbose) {
        int passed = 0;
        int exceptions = 0;
